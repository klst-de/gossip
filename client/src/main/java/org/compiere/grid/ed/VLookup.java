	...
	implements VEditor, ActionListener, FocusListener
{
	...
	private static final Logger LOG = Logger.getLogger(VLookup.class.getName());
	...
	{	
		super(); log.config("columnName:"+columnName);
...
//			}
	...
	{
//		m_mField = mField;
		LOG.warning("TODO auskommentiert"); return; // TODO
...
//		m_button.setEnabled(true);
	...
	private void actionText()
	{
		...
		//	Try like
		if (id == -3)
		{	LOG.warning("TODO //	Try like auskommentiert Class Info fehlt"); // TODO
