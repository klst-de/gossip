...
public class VEditorFactory
{
	 ...
	 *  @return grid editor
	 */
	public static VEditor getEditor (GridFieldBridge mField, boolean tableEditor)
	{
	 ...
	 *  @return grid editor
	 */
	public static VEditor getEditor (GridTab mTab, GridFieldBridge mField, boolean tableEditor)
	{
		if (mField == null)
			return null;
		...
		else if (displayType == DisplayType.Account)
		{
			...
			VAccount acct = new VAccount (columnName, mandatory, readOnly, updateable,
					mField.getAccountLookup(), mField.getHeader());
	 ...
	 *  @return Label
	 */
	public static CLabel getLabel (GridFieldBridge mField)
	{
		if (mField == null)
			return null;
