...
import org.jdesktop.swingx.demos.svg.FeatheRedit;
...
public final class VString extends CTextField implements VEditor, ActionListener
{
		...
		int displayLength, int fieldLength, String VFormat, String ObscureType)
	{
		...
		{			
            //FeatheRedit.of(JXIcon.SMALL_ICON, JXIcon.SMALL_ICON));
			mEditor = new CMenuItem(Msg.getMsg(Env.getCtx(), "Editor")
//					, Env.getImageIcon("Editor16.gif"));
					, FeatheRedit.of(JXIcon.SMALL_ICON, JXIcon.SMALL_ICON));
