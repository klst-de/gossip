...
// copied from (client) org.compiere.apps.form.TreeMaintenance
// subclasses: MenuPanel extends JXPanel
// TreeMaintenancePanel extends TreeMaintenance
...
public class TreeMaintenance {
	...
	public KeyNamePair[] getTreeData()
	{
		return DB.getKeyNamePairs(MRole.getDefault().addAccessSQL(
				// BB==BoM , PC==ProductCategory : see X_AD_Tree TreeType AD_Reference_ID=120
