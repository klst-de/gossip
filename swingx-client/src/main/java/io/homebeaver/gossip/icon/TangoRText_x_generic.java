 ...
 */
public class TangoRText_x_generic implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       TangoRText_x_generic base = new TangoRText_x_generic();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return TangoRText_x_generic::new;
    }
}
